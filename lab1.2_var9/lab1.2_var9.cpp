...
namespace Lab2 {
	...
	double Lemniscata_Bernoulli::getRadiusOfCurvatureDependingOnPhi(double angle) const // R =  2a^2/ 3 sqrt (2а^2 cos2angle) радиус кривизны в зависимости от угла полярного радиуса.
	{
